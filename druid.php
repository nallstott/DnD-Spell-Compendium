			...
			<div class="spell-list level2-list">
				<h3>Level 2</h3>
					<ul>
						...
						<li class="spell" id="flameBlade">Flame Blade</li>
			...
			<div class="spell-list level6-list">
				<h3>Level 6</h3>
					<ul>
						...
						<li class="spell" id="transportViaPlants">Transport via Plants</li>
						<li class="spell" id="trueSeeing">True Seeing</li>
						<li class="spell" id="wallOfThorns">Wall of Thorns</li>
						<li class="spell" id="windWalk">Wind Walk</li>
					</ul>
			</div>
