...
const searchForSpell = () =>{
	...
	const camelSpell = eval(camelCase(searchedSpell.value));
	console.log(camelSpell.srd);
	console.log(camelSpell);
	...
	if (camelSpell.srd){
		...
		spellName.innerHTML = "This spell is not available in the WOTC SRD documentation. Please consult the player's handbook directly.";
		spellLevel.innerHTML = '';
		spellType.innerHTML = '';
		spellCastingTime.innerHTML = '';
		spellRange.innerHTML = '';
