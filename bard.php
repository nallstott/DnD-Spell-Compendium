	...
	<div class="body-container">
		<div class="spell-list-container">
			<div class="spell-list cantrip-list">
				<h3>Cantrips</h3>
					<ul>
						...
						<li class="spell" id="viciousMockery">Vicious Mockery</li>
					</ul>
			</div>
			<div class="spell-list level1-list">
				<h3>Level 1</h3>
					<ul>
						...
						<li class="spell" id="dissonantWhispers">Dissonant Whisper</li>
			...
			<div class="spell-list level2-list">
				<h3>Level 2</h3>
					<ul>
						...
						<li class="spell" id="blindnessDeafness">Blindness/Deafness</li>
			...
			<div class="spell-list level4-list">
				<h3>Level 4</h3>
					<ul>
						<li class="spell" id="compulsion">Compulsion</li>
			...
			<div class="spell-list level9-list">
				<h3>Level 9</h3>
					<ul>
						...
						<li class="spell" id="powerWordHeal">Power Word Heal</li>
